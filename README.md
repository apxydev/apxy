...
APXY is a desktop network proxy that sits between your computer and the internet, letting you **inspect, mock, and debug** HTTP/HTTPS traffic. Use it through a **CLI** (30+ commands) or a **Web GUI**.
